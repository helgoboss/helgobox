pub mod root {
    ...
    pub const GLOBAL_HEIGHT_SCALE: f64 = 1.0000;
    #[cfg(target_os = "macos")]
    pub const GLOBAL_X_SCALE: f64 = 1.6500;
    #[cfg(target_os = "macos")]
    pub const GLOBAL_Y_SCALE: f64 = 1.5200;
    #[cfg(target_os = "macos")]
    pub const GLOBAL_WIDTH_SCALE: f64 = 1.6500;
    #[cfg(target_os = "macos")]
    ...
    #[cfg(target_os = "macos")]
    pub const MAPPING_PANEL_X_SCALE: f64 = 1.6500;
    #[cfg(target_os = "macos")]
    pub const MAPPING_PANEL_Y_SCALE: f64 = 1.4000;
    #[cfg(target_os = "macos")]
    pub const MAPPING_PANEL_WIDTH_SCALE: f64 = 1.6500;
    #[cfg(target_os = "macos")]
