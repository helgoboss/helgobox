...
pub mod root {
    ...
    const _: () = {
        ["Size of eel_function_table"][::std::mem::size_of::<eel_function_table>() - 16usize];
        ["Alignment of eel_function_table"][::std::mem::align_of::<eel_function_table>() - 8usize];
        ["Offset of field: eel_function_table::list"]
            [::std::mem::offset_of!(eel_function_table, list) - 0usize];
        ["Offset of field: eel_function_table::list_size"]
            [::std::mem::offset_of!(eel_function_table, list_size) - 8usize];
    };
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    unsafe extern "C" {
        pub fn NSEEL_VM_preallocram(ctx: root::NSEEL_VMCTX, maxent: ::std::os::raw::c_int);
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    #[allow(clippy::unnecessary_operation, clippy::identity_op)]
    const _: () = {
        ["Size of eelStringSegmentRec"][::std::mem::size_of::<eelStringSegmentRec>() - 24usize];
        ["Alignment of eelStringSegmentRec"]
            [::std::mem::align_of::<eelStringSegmentRec>() - 8usize];
        ["Offset of field: eelStringSegmentRec::_next"]
            [::std::mem::offset_of!(eelStringSegmentRec, _next) - 0usize];
        ["Offset of field: eelStringSegmentRec::str_start"]
            [::std::mem::offset_of!(eelStringSegmentRec, str_start) - 8usize];
        ["Offset of field: eelStringSegmentRec::str_len"]
            [::std::mem::offset_of!(eelStringSegmentRec, str_len) - 16usize];
    };
    unsafe extern "C" {
