...
pub mod root {
    ...
    fn bindgen_test_layout_eel_function_table() {
        ...
        fn test_field_list() {
            assert_eq!(
                unsafe {
                    let uninit = ::std::mem::MaybeUninit::<eel_function_table>::uninit();
    ...
    fn bindgen_test_layout_eelStringSegmentRec() {
        ...
        fn test_field__next() {
            assert_eq!(
                unsafe {
                    let uninit = ::std::mem::MaybeUninit::<eelStringSegmentRec>::uninit();
                    let ptr = uninit.as_ptr();
        ...
        test_field__next();
        fn test_field_str_start() {
            assert_eq!(
                unsafe {
                    let uninit = ::std::mem::MaybeUninit::<eelStringSegmentRec>::uninit();
                    let ptr = uninit.as_ptr();
                    ::std::ptr::addr_of!((*ptr).str_start) as usize - ptr as usize
                },
                8usize,
                concat!(
                    "Offset of field: ",
        ...
        test_field_str_start();
        fn test_field_str_len() {
            assert_eq!(
                unsafe {
                    let uninit = ::std::mem::MaybeUninit::<eelStringSegmentRec>::uninit();
                    let ptr = uninit.as_ptr();
                    ::std::ptr::addr_of!((*ptr).str_len) as usize - ptr as usize
                },
                16usize,
                concat!(
                    "Offset of field: ",
