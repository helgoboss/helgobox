...
pub struct UnresolvedActionTarget {
    ...
    pub enforce_7_bit_control: bool,
}
...
impl ActionTarget {
    fn invoke_with_fraction(&self, f: Fraction) -> Result<(), &'static str> {
        let value_change = if self.enforce_7_bit_control {
