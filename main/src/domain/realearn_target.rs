...
use crate::domain::{
    ...
    AUTOMATION_MODE_OVERRIDE_TARGET, BROWSE_POT_FILTER_ITEMS_TARGET, CLIP_COLUMN_TARGET,
    ...
    LOAD_POT_PRESET_TARGET, MIDI_SEND_TARGET, MOUSE_TARGET, NAVIGATE_WITHIN_GROUP_TARGET,
    NAVIGATE_WITHIN_POT_PRESETS_TARGET, OSC_SEND_TARGET, PLAYRATE_TARGET,
...
impl ReaperTargetType {
    ...
    pub const fn definition(self) -> &'static TargetTypeDef {
        ...
        match self {
            ...
            NavigateWithinPotPresets => &NAVIGATE_WITHIN_POT_PRESETS_TARGET,
