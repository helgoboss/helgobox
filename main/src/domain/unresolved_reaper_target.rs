...
use crate::domain::{
    ...
    UnresolvedBrowsePotFilterItemsTarget, UnresolvedClipColumnTarget,
...
pub enum UnresolvedReaperTarget {
    ...
    SelectedTrack(UnresolvedCycleThroughTracksTarget),
    ...
    NavigateWithinPotPresets(UnresolvedNavigateWithinPotPresetsTarget),
