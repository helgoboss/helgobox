...
pub enum UnresolvedReaperTarget {
    ...
    NavigateWithinPotPresets(UnresolvededNavigateWithinPotPresetsTarget),
    PreviewPotPreset(UnresolvededPreviewPotPresetTarget),
    LoadPotPreset(UnresolvededLoadPotPresetTarget),
}
