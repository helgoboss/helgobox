...
use crate::domain::{
    ...
    LearnMappingTarget, LoadFxSnapshotTarget, LoadPotPresetTarget, MappingControlContext,
    MidiSendTarget, OscSendTarget, PlayrateTarget, PreviewPotPresetTarget,
...
impl<'a> Target<'a> for ReaperTarget {
    ...
    fn current_value(&self, context: ControlContext) -> Option<AbsoluteValue> {
        ...
        match self {
            ...
            LearnMapping(t) => t.current_value(context),
