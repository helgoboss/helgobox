...
use crate::domain::{
    ...
    RouteMuteTarget, RoutePanTarget, RouteTouchStateTarget, RouteVolumeTarget,
    SaveMappingSnapshotTarget, SeekTarget, SelectedTrackTarget, TempoTarget, TrackArmTarget,
...
pub enum ReaperTarget {
    ...
    SaveMappingSnapshot(SaveMappingSnapshotTarget),
...
impl<'a> Target<'a> for ReaperTarget {
    ...
    fn current_value(&self, context: ControlContext) -> Option<AbsoluteValue> {
        ...
        match self {
            ...
            SaveMappingSnapshot(t) => t.current_value(context),
