...
Changes the targets of all currently listed mappings to use user-definable non-sticky object selectors.

1. Choose the desired track selector
2. Choose the desired FX selector
3. ReaLearn will change the selectors for the targets of all listed mappings where this is applicable
