...
====
If you want ReaLearn to send the current feedback value in text form at argument 1 and the color (see xref:user-interface/mapping-panel/glue-section.adoc#feedback-style-menu[]) as RRGGBB string at argument 2, you would enter:
