...
This source can be used in combination with the xref:targets/project-targets/project-set-tempo.adoc#project-set-tempo[Project: Set tempo] target to obtain a "poor man's" tempo synchronization.
