...
If you want to browse just a subset, see xref:target-types/pot-targets/pot-browse-filter-items.adoc#pot-browse-filter-items[].
...
Once you have selected a preset, you can audition it via xref:target-types/pot-targets/pot-preview-preset.adoc#pot-preview-preset[] (if it's a sound preset) and load it via xref:target-types/pot-targets/pot-load-preset.adoc#pot-load-preset[].
