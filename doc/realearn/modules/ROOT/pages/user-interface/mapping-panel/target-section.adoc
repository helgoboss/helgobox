...
Targets which control an on/off-style property of tracks (e.g. xref:targets/track/solo-unsolo.adoc#track-solounsolo[Track: Solo/unsolo]) additionally provide the following elements.
