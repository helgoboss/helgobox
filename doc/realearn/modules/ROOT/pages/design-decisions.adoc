...
The xref:user-interface/mapping-panel/advanced-settings-dialog.adoc[] makes it possible to configure a few advanced mapping settings by entering text in the YAML configuration language.
