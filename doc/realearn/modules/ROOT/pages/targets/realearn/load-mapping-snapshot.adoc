...
By ID:: Restores target values contained in a snapshot that was taken via xref:targets/realearn/take-mapping-snapshot.adoc#realearn-take-mapping-snapshot[].
