...
even more in the future. Of course, I don't have the resources to test them all, there are way too many. That's why
...
There's an https://github.com/helgoboss/realearn/tree/master/resources/controller-presets/unofficial/novation-launch-control-xl-mkii[unofficial preset] contributed by Bassman.
