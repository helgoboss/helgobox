...
Because the Clip Engine controller support is in a state of flux at the moment, you won't find suitable ReaLearn presets in ReaPack as usual. Instead, you need to copy Lua snippets from link:https://github.com/helgoboss/realearn[ReaLearn's project website on GitHub] and import them into ReaLearn via _Import from Clipboard_.

At first, open the ReaLearn FX instance "Clip Engine" on the track with the same name. Then follow below controller-specific instructions.
...
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/controller-presets/apc-key-25.lua[apc-key-25.lua] and import them into ReaLearn.
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/apc-key-25-to-clip-engine.lua[apc-key-25-to-clip-engine.lua] and import them into ReaLearn.
...
. Select the device both as _Control input_ and _Feedback output_.
. Import the controller preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/controller-presets/midi-fighter-twister.lua[midi-fighter-twister.lua] and import them into ReaLearn.
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/mft-to-clip-engine.lua[mft-to-clip-engine.lua] and import them into ReaLearn.
...
Support for DAW controllers is very incomplete and experimental because they are not grid controllers and therefore not my first priority. But you can roll your own integration by tweaking the Lua code. I tested this with a Behringer X-Touch One and an iCON Platform M+.

. Make sure your controller is operating in Mackie mode (MCU).
. Select the device both as _Control input_ and _Feedback output_.
. Import the controller preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/controller-presets/mackie-control.lua[mackie-control.lua] and import them into ReaLearn.
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/one-channel-daw-control-to-clip-engine.lua[one-channel-daw-control-to-clip-engine.lua] or link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/multi-channel-daw-control-to-clip-engine.lua[multi-channel-daw-control-to-clip-engine.lua] (depending on how many faders your control surface offers) and import them into ReaLearn.

For a basic test, press the _Play_ button. It should play a test clip.
...
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/osc-to-clip-engine.lua[osc-to-clip-engine.lua] and import them into ReaLearn.
...
. Import the controller preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/controller-presets/notes.lua[notes.lua] and import them into ReaLearn.
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/notes-to-clip-engine.lua[notes-to-clip-engine.lua] and import them into ReaLearn.
...
. Import the controller preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/controller-presets/qwerty.lua[qwerty.lua] and import them into ReaLearn.
. Import the main preset
* Copy the contents of link:https://github.com/helgoboss/realearn/blob/master/resources/main-presets/qwerty-to-clip-engine.lua[qwerty-to-clip-engine.lua] and import them into ReaLearn.
