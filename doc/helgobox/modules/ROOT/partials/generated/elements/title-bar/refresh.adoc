...
ifndef::pdf-theme[[[title-bar-refresh,Refresh image:helgobox::generated/screenshots/elements/title-bar/refresh.png[width=50]]]]
== Refresh

image:helgobox::generated/screenshots/elements/title-bar/refresh.png[Refresh, role="related thumb right"]
