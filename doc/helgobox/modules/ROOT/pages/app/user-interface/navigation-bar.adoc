...
You can show or hide it using the xref:app/user-interface/title-bar.adoc#title-bar-toggle-nav-bar[image:generated/screenshots/elements/title-bar/toggle-nav-bar.png[]] button in the xref:app/user-interface/title-bar.adoc[].
