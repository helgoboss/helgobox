...
* Needs Windows 10 or later (TODO in the upcoming version, ReaLearn will support Windows 7 and 8 again!)
...
* For macOS 10.15 or later, all below-mentioned installation options should work
* **For macOS 10.14 or earlier, installation via installer is not supported.
...
You can use it if you have Windows 7+ or macOS 10.15+.
