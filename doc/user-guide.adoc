...
|===
|Last update of text: |`2021-09-06 (v2.10.0)`
...
** It can't participate in <<_realearn_load_mapping_snapshot>>.
** It can't participate in mapping autostart.
====
...
At the moment, this target simply restores the initial target values for each mapping in this ReaLearn instances.
In future, it will be able to do much more.
...
=== Like tutorial 1, but with previous/next buttons
