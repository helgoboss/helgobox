...
[%collapsible]
====
image:images/images 2/Realearn parameter viewer.jpg[parameter list viewer]
====
...
|====
3+|<<mapping>> .11+|image:images/images 2/Panel-Mapping color area.jpg[Mapping panel]
