...
ifndef::pdf-theme[[[track-panel-input-type-indicator,Track input type indicator image:generated/screenshots/elements/track-panel/input-type-indicator.png[width=50]]]]
