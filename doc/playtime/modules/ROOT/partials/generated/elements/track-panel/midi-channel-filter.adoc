...
ifndef::pdf-theme[[[track-panel-midi-channel-filter,MIDI channel filter image:generated/screenshots/elements/track-panel/midi-channel-filter.png[width=50]]]]
=== MIDI channel filter
