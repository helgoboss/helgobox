ifdef::pdf-theme[[[toolbar-start-stop-playback,Start/stop playback]]]
ifndef::pdf-theme[[[toolbar-start-stop-playback,Start/stop playback image:playtime::generated/screenshots/elements/toolbar/start-stop-playback.png[width=50]]]]
=== Start/stop playback

image:playtime::generated/screenshots/elements/toolbar/start-stop-playback.png[Start/stop playback, role="related thumb right"]
