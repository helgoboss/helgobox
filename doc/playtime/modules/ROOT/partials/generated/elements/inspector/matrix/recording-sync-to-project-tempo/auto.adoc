...
ifndef::pdf-theme[[[inspector-matrix-recording-sync-to-project-tempo-auto,Auto image:generated/screenshots/elements/inspector/matrix/recording-sync-to-project-tempo/auto.png[width=50]]]]
=== Auto
