...
This is a shortcut for xref:user-interface/inspector/column.adoc#inspector-column-exclusive-mode[].

include::partial$generated/elements/column-cell/follow-scenes.adoc[]

This is a shortcut for xref:user-interface/inspector/column.adoc#inspector-column-follow-scenes[].
