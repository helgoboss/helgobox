...
TIP: Selecting one of the *Loopback* channels as audio input doesn't automatically enable it!
...
NOTE: See <<input-monitoring-explained>> to learn how this is translated to REAPER track properties.
