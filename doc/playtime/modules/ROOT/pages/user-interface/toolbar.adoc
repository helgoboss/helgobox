...
. Switch xref:user-interface/inspector/matrix.adoc#inspector-matrix-transport-sync[] to **Full**
...
The purpose of this feature is to quickly create simple mappings of MIDI keys/pads/buttons to cells. If you want to use full-featured grid controllers, such as the Launchpad, see xref:realearn::user-interface/settings-dialog.adoc#controllers[].
