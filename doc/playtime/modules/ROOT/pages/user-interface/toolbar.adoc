...
* If you are looking for out-of-the-box support for full-featured grid controllers, such as the Launchpad, see xref:realearn::user-interface/settings-dialog.adoc#controllers[]. There's also a related link:https://youtu.be/tkyNCGOVumw?si=fIKvd_rogtvMzvrp[YouTube video].
