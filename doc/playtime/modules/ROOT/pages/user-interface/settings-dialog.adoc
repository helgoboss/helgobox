...
This dialog opens when pressing the xref:helgobox::app/user-interface/title-bar.adoc#title-bar-settings[image:helgobox::generated/screenshots/elements/title-bar/settings.png[]] button in the title bar and navigating to the Playtime section.
